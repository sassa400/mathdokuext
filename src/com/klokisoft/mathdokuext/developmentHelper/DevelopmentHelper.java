package com.klokisoft.mathdokuext.developmentHelper;
...
import com.klokisoft.mathdokuext.gridGenerating.GridGenerator;
...
public class DevelopmentHelper {
	public static String TAG_LOG = "MathDokuExt.DevelopmentHelper";

	public enum Mode {
		DEVELOPMENT, BUG_SENSE, PRODUCTION
	}

    public static final Mode mMode = Mode.PRODUCTION; // SASSA
