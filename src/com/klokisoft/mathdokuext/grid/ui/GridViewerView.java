...
import com.klokisoft.mathdokuext.painter.GridPainter;
import com.klokisoft.mathdokuext.painter.Painter;
import com.klokisoft.mathdokuext.painter.Painter.DigitPainterMode;
...
public class GridViewerView extends View {
	...
	private static final String TAG = "MathDokuExt.GridViewerView";
...
//			mGridCellSize = (float) Math.floor(maxSize / (mGridSize + 1));
			mGridCellSize = (float) Math.floor(maxSize / mGridSize); //SASSA
