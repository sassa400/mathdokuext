package com.klokisoft.mathdokuext.gridGenerating;

import com.klokisoft.mathdokuext.grid.GridCell;

public class GridCageType {
	public static final String TAG = "MathDokuExt.GridCageType";
	...
	public boolean[][] getExtendedCageTypeMatrix() {
		...
		for (int row = 0; row < mRows; row++) {
            System.arraycopy(mUsedCells[row], 0, extendedUsedCells[row + 1], 1, mCols);
		}
