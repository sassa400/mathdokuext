...
public class CellPainter extends BorderPainter {
	...
	// Background for the only one possibility cell
	private final Paint mOnlyOneBackgroundPaint;
	/**
	...
	public CellPainter(Painter painter) {
		...
		// Background for the only one possibility cell.
		mOnlyOneBackgroundPaint = new Paint();
		mOnlyOneBackgroundPaint.setStyle(Paint.Style.FILL);
		mOnlyOneBackgroundPaint.setColor(0xFFabffab);
	}
	...
	public void setTheme(GridTheme theme) {
		...
		switch (theme) {
		case EXTENDED:
			mSelectedBorderPaint.setColor(0xFFFFFF94);
	...
	/**
	 * Get the paint for the background if there is only one possibility.
	 * 
	 * @return The paint for the background of the cell.
	 */
	public Paint getOnlyOneBackgroundPaint() {
		return mOnlyOneBackgroundPaint;
	}
}