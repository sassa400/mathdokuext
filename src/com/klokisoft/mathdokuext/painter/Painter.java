...
//		mButtonBackgroundColor = 0xFF33B5E5;
		mButtonBackgroundColor = 0xFF093748; //SASSA
		
		mDigitFgColor = 0xFFFFFFFF;
		mDigitFgMaybeColor = 0xFFFFD700; //SASSA gold
	...
	private void setInputModeColors(GridTheme gridTheme) {
		// Colors of highlighted digits should be equal for all themes as the input_mode-images are
...
//		mHighlightedTextColorMaybeInputMode = 0xFFFF8A00;
		...
		switch (gridTheme) {
		case EXTENDED: 
			mHighlightedTextColorNormalInputMode = 0xFF025590;
			mHighlightedTextColorMaybeInputMode = 0xFF800000;
