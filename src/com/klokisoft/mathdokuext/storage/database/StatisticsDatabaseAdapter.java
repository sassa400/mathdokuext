package com.klokisoft.mathdokuext.storage.database;
...
import com.klokisoft.mathdokuext.statistics.CumulativeStatistics;
import com.klokisoft.mathdokuext.statistics.GridStatistics;
import com.klokisoft.mathdokuext.statistics.HistoricStatistics;
import com.klokisoft.mathdokuext.statistics.HistoricStatistics.Serie;
import com.klokisoft.mathdokuext.storage.database.Projection.Aggregation;
...
public class StatisticsDatabaseAdapter extends DatabaseAdapter {
	private static final String TAG = "MathDokuExt.StatisticsDatabaseAdapter";
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.klokisoft.mathdokuext.storage.database.DatabaseAdapter#getCreateSQL()
	 */
	@Override
