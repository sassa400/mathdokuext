...
import com.klokisoft.mathdokuext.grid.DigitPositionGrid;
import com.klokisoft.mathdokuext.grid.Grid;
import com.klokisoft.mathdokuext.grid.ui.GridViewerView;
...
public class ArchiveFragment extends StatisticsBaseFragment implements
	...
	public static final String BUNDLE_KEY_SHOW_NEW_BUTTON = "showNewButton";
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		mShowNewButton = args.getBoolean(BUNDLE_KEY_SHOW_NEW_BUTTON);
		...
		if (grid.load(mSolvingAttemptId)) {
			...
			// Set background color of button or don't show at all
			Button archiveNewButton = (Button) rootView
					.findViewById(R.id.archiveNewButton);
			if (mShowNewButton)
			{
				archiveNewButton.setVisibility(View.VISIBLE);
				archiveNewButton.setBackgroundColor(Painter.getInstance()
					.getButtonBackgroundColor());
			}
			else
			{
				archiveNewButton.setVisibility(View.GONE);
			}
